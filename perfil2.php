...
$sql2 = "SELECT * FROM pet WHERE id_usu = '$id' && desabilitar_pet = '0'";
  ...
  if($rua==''){  
    ...
    <div class="mt-5 row">
      ...
      <div class="col-12 text-center">
        ...
        <a href="marcarConsulta.php" type="button" class="btn btn-primary" > 
          Marcar Consulta
        </a>
      </div>
...
function list(){
 ...
 <option>ShihTzu</option>
 <option>Desconhecida/Indefinida</option>
     </select>
    `;
    break;
