...
if(isset($_POST['busca'])){
  ...
  $sql = "SELECT * FROM expediente WHERE `desabilitar_exp` = 0";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="text-center">Configurações do Proprietário</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="container-fluid">
        ...
        <div class=" col-12" style="">
             ...
             <br>
                ...
                <h4 class="text-center">Inserir Horários de Consulta</h4>
    

        <div class="mt-3" id="caixa" style=" ">
              ...
              <!-- form start -->
                ...
                <form action="inserirExp.php" method="post">
                    <label for="inicio">Início</label>
                    <input type="time" class="form-control" name="inicio_exp" id="inicio" placeholder="Serviço">
                  </div>
                  <div class="form-group col-5">
                      <label for="fim">Fim</label>
                    
                    <input type="time" name="fim_exp" class="form-control" id="fim" placeholder="Valor">
                  </div>
  ...
  <div class='modal-dialog'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
       <a href='excluirExp.php?id=$id' type='button' class='btn btn-danger'>Excluir</a>
      </div>
    </div>
  </div>
</div>
...
<div class="mt-3" id="caixa" style=" ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                <div class="text-center row" id="dia">
                    <div class="form-group  col-7">
                <form action="inserirFolga.php"  method="post">
                    <label for="inicio">Dia de folga</label>
                     
                    <!-- <input type="number" id="diafolga" min="0" max="6" class="form-control" name="folga_exp" id="inicio" placeholder="Dia de folga"> -->
                    <select class="form-control" name="folga_des" id="tipoConsulta">
          ...
          <option value="7">Sem folga</option>
                    </select>
                  </div>
                <div class="form-group col-2 mt-2">
                    <br>
      ...
      function diaFolga(){
        ...
        var folgadia = document.getElementById("diafolga");
        
        console.log(folgadia.value)
          

              if(folgadia.value == 0){
                dia.innerHTML = `<p>Segunda-feira..</p>`;
                 return false;
              }
              else if(folgadia.value == 1){
                dia.innerHTML = `<p>Terça-feira..</p>`;
                 return false;
              }
              else if(folgadia.value == 2){
                dia.innerHTML = `<p>Quarta-feira..</p>`;
                 return false;
              }
              else if(folgadia.value == 3){
                dia.innerHTML = `<p>Quinta-feira..</p>`;
                 return false;
              }
              else if(folgadia.value == 4){
                dia.innerHTML = `<p>Sexta-feira..</p>`;
                 return false;
              }
              else if(folgadia.value == 5){
                dia.innerHTML = `<p>Sábado..</p>`;
                 return false;
              }
              else if(folgadia.value == 6){
                dia.innerHTML = `<p>Domingo..</p>`;
                 return false;
              }
            }
            </script>
