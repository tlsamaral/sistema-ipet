...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="text-center">Consultas Pendentes</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
<?php
$sql = "SELECT * FROM consulta WHERE status_con = 'Pendente'";
...
<ul class='list-group list-group-flush card '>
  <li class='list-group-item'><h5>Descrição:</h5> $descricao </li>
              ...
              <a href='recusar.php?id=$id' class='btn btn-danger'>Recusar</a>
              <a href='aceitar.php?id=$id' class='btn btn-success'>Aceitar</a>
            </div>
