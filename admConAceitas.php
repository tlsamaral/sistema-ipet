...
$sql4 = "SELECT * FROM usuario WHERE email_usu = '$email' && senha_usu = '$senha' LIMIT 1";

$dados4 = mysqli_query($conn, $sql4);
while($row = mysqli_fetch_assoc($dados4) ){
  $id = $row['id_usu'];
}
$_SESSION['id_usu'] = $id;
...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
<?php
$sql = "SELECT * FROM consulta WHERE status_con = 'Aceita'";
$dados = mysqli_query($conn, $sql);
  ...
  $idu = $_SESSION['id_usu'];
$sql3 = "SELECT * FROM consulta WHERE id_usu = $idu";
...
$dado5 = mysqli_query($conn, $sql5);
  ...
  <li class='list-group-item'><h5>Cliente:";while($rowu = mysqli_fetch_assoc($dadou)  ){echo $rowu['nome_usu'];}echo"</h5> </li>
...
<ul class='list-group list-group-flush card col-6'>
  ...
  <li class='list-group-item'><h5>Taxi: $taxi</h5></li>
...
<ul class='list-group list-group-flush card '>
  <li class='list-group-item'><h5>Descrição:</h5> $descricao </li>
              ...
              </div>";if($status == "Aceita" && $acompanhar == "Sim" ){echo"<a href='$linkBanho' class='btn btn-primary'>Transmitir</a>";}echo"
              <a href='cancelar.php?id=$id' class='btn btn-danger'>Cancelar</a>
              <a href='concluir.php?id=$id' class='btn btn-success'>Concluir</a>
            </div>
