...
if(isset($_POST['busca'])){
  ...
  $sql = "SELECT * FROM gasto WHERE nome_gas LIKE '%$pesquisa%' ";
      ...
      <div class="container-fluid">
        ...
        <div class=" col-12" style="">
             ...
             <br>
                ...
                <h4 class="text-center">Inserir Gasto</h4>
        ...
        <div class="mt-3" id="caixa" style=" ">
              ...
              <!-- form start -->
                ...
                <form action="inserirGas.php" method="post">
                    <label for="nome">Nome</label>
                    <input type="text" class="form-control" name="nome_gas" id="nome" placeholder="Nome">
                  </div>
                  <div class="form-group col-5">
                      <label for="valor">Valor</label>
                    <input type="number" name="valor_gas" class="form-control" id="valor" placeholder="Valor">
                  </div>
...
<form action="config.php" method="POST" >
    ...
    <form action="admFinGastos.php" method="POST" >
      <div class="container">
      <div class="row ">
        <div class="col-10">
